...
import static com.facebook.presto.plugin.geospatial.GeoFunctions.stConvexHull;
...
public class BenchmarkSTConvexHull
{
            ...
            throws RunnerException
    {
        Options options = new OptionsBuilder()
                ...
                .include(".*" + BenchmarkSTConvexHull.class.getSimpleName() + ".*")
                .build();
        new Runner(options).run();
    }

    @Benchmark
    public Object stConvexHullPoint(BenchmarkData data)
    {
        return stConvexHull(data.point);
    }

    @Benchmark
    public Object stConvexHullMultiPointSparse(BenchmarkData data)
    {
        return stConvexHull(data.multiPointSparse);
    }

    @Benchmark
    public Object stConvexHullMultiPointDense(BenchmarkData data)
    {
        return stConvexHull(data.multiPointDense);
    }

    @Benchmark
    public Object stConvexHullMultiPointReallyDense(BenchmarkData data)
    {
        return stConvexHull(data.multiPointReallyDense);
    }

    @Benchmark
    public Object stConvexHullLineStringCircle(BenchmarkData data)
    {
        return stConvexHull(data.lineStringCircle);
    }

    @Benchmark
    public Object stConvexHullLineStringDense(BenchmarkData data)
    {
        return stConvexHull(data.lineStringDense);
    }

    @Benchmark
    public Object stConvexHullPolygonSimple(BenchmarkData data)
    {
        return stConvexHull(data.polygonSimple);
    }

    @Benchmark
    public Object stConvexHullPolygonNormal(BenchmarkData data)
    {
        return stConvexHull(data.polygonNormal);
    }

    @Benchmark
    public Object stConvexHullPolygonDense(BenchmarkData data)
    {
        return stConvexHull(data.polygonComplex);
    }
